...
public abstract class TargetedArtificerSpell extends ArtificerSpell {
    ...
    public void onCast(PocketWorkshop workshop, Hero hero ){
        GameScene.selectCell(new CellSelector.Listener() {
            ...
            public void onSelect(Integer cell) {
                onTargetSelected(workshop, hero, cell);
            }
    ...
    protected abstract void onTargetSelected(PocketWorkshop workshop, Hero hero, Integer target);
